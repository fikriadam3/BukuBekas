<!-- profil -->
  ...
  <nav class="navbar navbar-dark bg-dark navbar-expand-lg bg-body-tertiary">
	  ...
	  <?php if (empty($_SESSION)) { echo 'display:none;'; } ?>">
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Profil <?= $_SESSION['level']; ?></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      
      <!-- Logout -->
		<div align="right" <?php if (empty($_SESSION)) {echo "style='display: none;'";} ?> >
      ...
      <div class="modal-body">
		...
		<div class="input-group flex-nowrap mt-2 mb-2">
		  	...
		  	<input type="text" class="form-control" id="no" name="no" value="<?= $data['user']['no_telp'] ?>">
		</div>
      </div>
